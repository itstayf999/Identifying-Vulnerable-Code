...
with open(os.path.join(OUT_DIR, "linear_svm_calibrated_model.pkl"), "wb") as f:
    pickle.dump(model, f)
...
pred_df.to_csv(os.path.join(OUT_DIR, "test_predictions.csv"), index=False, encoding="utf-8-sig")

plot_conf_matrix(cm, "Linear SVM - Confusion Matrix",
